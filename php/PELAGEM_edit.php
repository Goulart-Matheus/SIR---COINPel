...
$tab->setTab('Pelagem', 'fas fa-horse', 'PELAGEM_viewDados.php');
$tab->setTab('Editar', 'fas fa-pencil-alt', $_SERVER['PHP_SELF']);

$tab->printTab($_SERVER['PHP_SELF']);

$query->exec("SELECT id_pelagem , descricao , habilitado  FROM pelagem WHERE id_pelagem = " . $id_pelagem);
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <select class="form-control" name="form_habilitado">
                            <option value="S" <? if ($edit && $form_habilitado == "S") echo 'selected';
                                                else {
                                                    if (!$edit && $query->record[2] == "S") {
                                                        echo 'selected';
                                                    }
                                                } ?>>Sim</option>
                            <option value="N" <? if ($edit && $form_habilitado == "N") echo 'selected';
                                                else {
                                                    if (!$edit && $query->record[2] == "N") {
                                                        echo 'selected';
                                                    }
                                                } ?>>Não</option>
                        </select>
